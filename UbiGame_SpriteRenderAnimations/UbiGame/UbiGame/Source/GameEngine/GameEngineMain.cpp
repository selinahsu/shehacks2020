...
float GameEngineMain::WINDOW_HEIGHT = 1500;
float GameEngineMain::WINDOW_WIDTH = 1500;
...
{
	m_renderWindow = new sf::RenderWindow(sf::VideoMode((unsigned int)WINDOW_WIDTH, (unsigned int)WINDOW_HEIGHT), "Flare Game");
